...
function patchCallback(instrumentationConfig, span, cb, recordDuration) {
...
function updateCounter(pool, connectionCount, connectionPendingRequests, latestCounter) {
